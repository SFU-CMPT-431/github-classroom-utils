...
to the GitHub servers whenever possible. These tools now run _significantly_ faster.
...
1. If you haven't already done this, you'll first need to

```pip3 install --user iso8601 pandas matplotlib requests aiohttp`
...
2. git clone https://github.com/SFU-CMPT-431/github-classroom-utils
...
you can go back into GitHub Classroom's settings and make sure that _future_
...
This program uses the GitHub "Events" API to print all of the _push_ times
